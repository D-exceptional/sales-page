!(function (t, e) {
  ...
  var P,
    ...
    rt = '\n <div aria-labelledby="'
      ...
      .concat(S.icon, " ")
      .concat(h.question, '"></div>\n     <div class="')
      .concat(S.icon, " ")
      .concat(h.warning, '"></div>\n     <div class="')
      .concat(S.icon, " ")
      .concat(h.info, '"></div>\n     <div class="')
      .concat(S.icon, " ")
      .concat(
  ...
  var ft = function (t, e) {
      ...
      a &&
        ...
        "string" == typeof (o = e.backdrop)
          ...
          : o || O([document.documentElement, document.body], S["no-backdrop"]),
        !e.backdrop &&
          e.allowOutsideClick &&
          m(
        ...
        (r = e.position) in S
          ? O(i, S[r])
          : (m('The "position" parameter is not valid, defaulting to "center"'),
            O(i, S.center)),
        (function (t, e) {
  ...
  var yt = function (t, e) {
    ...
    kt = function (t, u) {
      ...
      j(c), (c.innerHTML = "");
      var l = parseInt(
        null === u.currentProgressStep
          ? se.getQueueStep()
          : u.currentProgressStep
      );
      l >= u.progressSteps.length &&
        m(
    ...
    xt = function (t, e) {
      ...
      (n = e),
        ...
        (o.className = S.popup),
        n.toast
          ? (O([document.documentElement, document.body], S["toast-shown"]),
            O(o, S.toast))
          : O(o, S.modal),
  ...
  var Ht = function () {
    ...
    Rt = function () {
      null !== v.previousBodyPadding &&
        ((document.body.style.paddingRight = v.previousBodyPadding + "px"),
        (v.previousBodyPadding = null));
    },
    Dt = function () {
  ...
  var te = function (t) {
      ...
      null !== t.onBeforeOpen &&
        ...
        t.onBeforeOpen(n),
        t.animation && (O(n, S.show), O(e, S.fade)),
        j(n),
        lt && !b(n, S.noanimation)
        ...
        t.heightAuto &&
          t.backdrop &&
          !t.toast &&
          O([document.documentElement, document.body], S["height-auto"]),
        nt() &&
  ...
  var ie,
    re = Object.freeze({
      ...
      _main: function (t) {
        ...
        return new Promise(function (t) {
          var n = function (t) {
              h.closePopup({ value: t });
            },
            s = function (t) {
              h.closePopup({ dismiss: t });
            };
          ...
          for (
            var u = function (e) {
              ...
              o = b.popup.querySelectorAll("button"),
              i = 0;
            i < o.length;
            i++
          )
              ...
              (b.container.onmousedown = function () {
                b.popup.onmouseup = function (t) {
                  (b.popup.onmouseup = void 0),
                    (t.target === b.popup || b.popup.contains(t.target)) &&
                      (r = !0);
                };
              }),
          ...
          Pt.keydownHandlerAdded &&
                  ...
                  if (
                    ...
                    if ("Tab" === t.key) {
                      ...
                      [
                        ...
                        ? document.activeElement === b.confirmButton &&
                          H(b.cancelButton)
                          ? b.cancelButton.focus()
                          : document.activeElement === b.cancelButton &&
                            H(b.confirmButton) &&
                            b.confirmButton.focus()
                        : ("Escape" !== t.key && "Esc" !== t.key) ||
                          !0 !== B(e.allowEscapeKey) ||
                          (t.preventDefault(), s(y.DismissReason.esc));
                  else if (
                    t.target &&
                    h.getInput() &&
                    t.target.outerHTML === h.getInput().outerHTML
                  ) {
            ...
            h.hideLoading(),
            h.resetValidationMessage(),
            v.toast && (v.input || v.footer || v.showCloseButton)
              ? O(document.body, S["toast-column"])
              : T(document.body, S["toast-column"]),
            "select" === v.input || "radio" === v.input
              ...
              : -1 !==
                ...
                c.inputValue
                  .then(function (t) {
                    (l.value =
                      "number" === c.input ? parseFloat(t) || 0 : t + ""),
                      j(l),
                      l.focus(),
                      a.hideLoading();
                  })
            ...
            v.toast ||
              (B(v.allowEnterKey)
                ? v.focusCancel && H(b.cancelButton)
                  ? b.cancelButton.focus()
                  : v.focusConfirm && H(b.confirmButton)
                  ? b.confirmButton.focus()
                  : g(-1, 1)
